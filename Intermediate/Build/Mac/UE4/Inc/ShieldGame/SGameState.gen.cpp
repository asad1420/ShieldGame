...
#include "ShieldGame/SGameState.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	SHIELDGAME_API UEnum* Z_Construct_UEnum_ShieldGame_EWaveState();
	UPackage* Z_Construct_UPackage__Script_ShieldGame();
	SHIELDGAME_API UClass* Z_Construct_UClass_ASGameState_NoRegister();
	SHIELDGAME_API UClass* Z_Construct_UClass_ASGameState();
...
// End Cross Module References
	static UEnum* EWaveState_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_ShieldGame_EWaveState, Z_Construct_UPackage__Script_ShieldGame(), TEXT("EWaveState"));
		}
		return Singleton;
	}
	...
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EWaveState(EWaveState_StaticEnum, TEXT("/Script/ShieldGame"), TEXT("EWaveState"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_ShieldGame_EWaveState_Hash() { return 1679466595U; }
	UEnum* Z_Construct_UEnum_ShieldGame_EWaveState()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_ShieldGame();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EWaveState"), 0, Get_Z_Construct_UEnum_ShieldGame_EWaveState_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			...
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "ModuleRelativePath", "SGameState.h" },
	...
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ASGameState_OnRep_WaveState_Statics::NewProp_OldState = { "OldState", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(SGameState_eventOnRep_WaveState_Parms, OldState), Z_Construct_UEnum_ShieldGame_EWaveState, METADATA_PARAMS(nullptr, 0) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ASGameState_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ASGameState_OnRep_WaveState, "OnRep_WaveState" }, // 256368099
		{ &Z_Construct_UFunction_ASGameState_WaveStateChanged, "WaveStateChanged" }, // 554840630
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState = { "WaveState", "OnRep_WaveState", (EPropertyFlags)0x0020080100000034, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ASGameState, WaveState), Z_Construct_UEnum_ShieldGame_EWaveState, METADATA_PARAMS(Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ASGameState_Statics::NewProp_WaveState_MetaData)) };
	...
	IMPLEMENT_CLASS(ASGameState, 606705547);
	template<> SHIELDGAME_API UClass* StaticClass<ASGameState>()
	{
		return ASGameState::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_ASGameState(Z_Construct_UClass_ASGameState, &ASGameState::StaticClass, TEXT("/Script/ShieldGame"), TEXT("ASGameState"), false, nullptr, nullptr, nullptr);
