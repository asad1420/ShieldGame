...
void EmptyLinkFunctionForGeneratedCodeShieldGame_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_ShieldGame()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_ShieldGame_OnHealthChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_ShieldGame_OnActorKilled__DelegateSignature,
			};
